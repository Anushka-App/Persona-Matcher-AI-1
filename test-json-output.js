...
// Main recommendation function - EXACT JSON OUTPUT FORMAT
function generateRecommendations(userArtworkTheme, userProductType, personalityScores = null, sentiment = null) {
    ...
    // Step 9: Return EXACT JSON format as specified
    return {
        suggestedBagType,
        confidence,
        insights,
...
// Test the exact JSON output format
console.log('🎨 TESTING EXACT JSON OUTPUT FORMAT\n');
...
console.log('✅ Schema matches specification exactly');
